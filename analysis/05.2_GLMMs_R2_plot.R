...
R2_partial <- read_csv("results/Tables_R2_partial.csv") %>% 
  mutate(predictor=recode_factor(predictor,"Grazing legacy"="Grazing history",
                                           "Habitat type"="Habitat (management type)")) %>% 
  mutate(predictor=fct_relevel(predictor,
                                  c("Habitat (management type)",
  ...
  mutate(variab_group=recode_factor(predictor,
                                    "Habitat (management type)" ="Management type/stability/legacy",
                                    ...
                                    "Grazing history" = "Management type/stability/legacy",  
